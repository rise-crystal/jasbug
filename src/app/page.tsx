    ...
    <main className="min-h-screen bg-gray-950 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-lg">
          {/* Warning Banner */}
          <div className="bg-gradient-to-r from-red-600 to-orange-600 text-center py-2 px-4 rounded-t-2xl">
          ...
          {/* Main Card */}
          <div className="bg-gray-900 border-x-2 border-b-2 border-red-500/50 rounded-b-2xl shadow-2xl shadow-red-500/20 p-8">
            {/* Product Display */}
            <div className="text-center mb-6">
              <div className="relative inline-block">
                ...
                <div className="relative bg-gradient-to-br from-red-950 to-gray-900 rounded-2xl p-6 border-2 border-red-500/50 mb-4">
                  ...
                  <div className="flex justify-center gap-2 mt-3">
                    ...
                    <span className="bg-orange-600 text-white text-xs font-bold px-3 py-1 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}>
                      ⚡ DESTRUCTIVE
                    </span>
                  </div>
                </div>
              ...
              <h2 className="text-4xl font-black mb-2 relative inline-block">
              ...
              <p className="text-gray-400 text-sm mb-4">Ultimate Bug & Malware Collection</p>

              {/* Price Tag */}
              <div className="inline-block bg-gradient-to-r from-red-600 to-orange-600 text-white px-8 py-3 rounded-full font-black text-xl shadow-lg shadow-red-500/50">
                <span className="text-sm font-normal">Rp</span> 10.000
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 mt-6">
                <div className="bg-gray-800 rounded-lg p-3 border border-red-500/30">
                  ...
                  <div className="text-white font-bold text-sm">Deadly</div>
            ...
            <div className="flex items-center gap-3 my-6">
              ...
              <span className="text-red-500 text-xs font-bold">⚠️ TARGET INPUT</span>
              <div className="flex-1 h-px bg-gradient-to-r from-transparent via-red-500 to-transparent"></div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label
                  htmlFor="phoneNumber"
                  className="block text-sm font-bold text-red-400 mb-2 uppercase tracking-wider"
                >
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-800 border-2 border-red-500/50 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition font-mono"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-black py-4 rounded-lg transition-all duration-200 cursor-pointer disabled:cursor-not-allowed text-lg shadow-lg shadow-red-500/50 hover:shadow-red-500/80 transform hover:scale-105 disabled:transform-none"
              >
